...
findMinimalGraphSet = function(n = 9L, r = 3L, s = 4L, maxOrder = 6L, symRS = FALSE, lowerOnly = FALSE, minAuto = NULL, factor = FALSE, eps = NA, strongCuts = FALSE,
                      extremeOnly = FALSE, treesOnly = FALSE, twoTreesOnly = FALSE, ETOnly = FALSE, partiteOnly = FALSE, completeOnly = FALSE, inds = NULL, star = NULL) {
  lastSolution = NULL
  ...
  while (any(is.na(dispensable))) {
    ...
    extremeOnly = extremeOnly, treesOnly = treesOnly, twoTreesOnly = twoTreesOnly, ETOnly = ETOnly, partiteOnly = partiteOnly, completeOnly = completeOnly, star = star,
    inds = altInds)
    if (!is.null(altRes[[4]])) {
...
iterateLPProof = function(n = 6L, r = 3L, s = r, maxOrder = round(2 * n / 3), symRS = (r == s), lowerOnly = FALSE, minAuto = NULL, factor = FALSE, eps = NA, strongCuts = TRUE,
                 extremeOnly = FALSE, treesOnly = FALSE, twoTreesOnly = FALSE, ETOnly = FALSE, partiteOnly = FALSE, completeOnly = FALSE, star = NULL, inds = NULL) {
